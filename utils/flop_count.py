...
def count_flops(model, inputs):
    flops, skips = flop_count(
            ...
            supported_ops={
                ...
                "aten::fft_fft2": generic_pooling_jit("fft_fft2", multiplier=5),  # O(N log N) complexity
                "aten::ifft_ifft2": generic_pooling_jit("ifft_ifft2", multiplier=5),  # O(N log N) complexity
            }
        )
